...
interface IcoWithdrawProps {
  color?: string;
  size?: number;
  style?: StyleProp<ViewStyle>;
}

export function IcoWithdraw({ color = 'white', size = 24, style }: IcoWithdrawProps) {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <Path fill={color} d="M29,23a1,1,0,0,0-1,1v4a1,1,0,0,0,2,0V24A1,1,0,0,0,29,23Z" />
      <Path fill={color} d="M3,16a1,1,0,0,0-1,1v4a1,1,0,0,0,2,0V17A1,1,0,0,0,3,16Z" />
      <Path
        fill={color}
      ...
      />
      <Path fill={color} d="M16,23a1,1,0,0,0-1,1v2a1,1,0,0,0,2,0V24A1,1,0,0,0,16,23Z" />
    </Svg>
  );
}
